                            ...
                            <div class="row">
                                <div class="col-12 mb-1">
                                    <div class="widget-banner">
                                        <a href="#">
                                            <img src="./assets/img/banner/banner-side-slider-1.jfif" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="widget-banner">
                                        <a href="#">
                                            <img src="./assets/img/banner/banner-side-slider-2.png" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <section id="main-slider"
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                <a class="main-slider-slide" href="#">
                                    <img src="./assets/img/main-slider/img-slider-2/2.png" alt="" class="img-fluid">
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="item">
                                <div class="product-card mb-3">
                                    <a class="product-thumb" href="">
                                        <img src="./assets/img/products/flutter.png" alt="Product Thumbnail">
                                    </a>
                                    <div class="product-card-body">
                                        <h5 class="product-title">
                                            <a href="">فلاتر</a>
                                        </h5>
                                        <a class="product-meta" href="">فلاتر</a>
                                        <span class="product-price">350,000 تومان</span>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="product-card mb-3">
                                    <a class="product-thumb" href="">
                                        <img src="./assets/img/products/android.png" alt="Product Thumbnail">
                                    </a>
                                    <div class="product-card-body">
                                        <h5 class="product-title">
                                            <a href="">اندروید</a>
                                        </h5>
                                        <a class="product-meta" href="">اندروید</a>
                            ...
                            <div class="item">
                                <div class="product-card mb-3">
                                    ...
                                    <div class="product-card-body">
                                        ...
                                        <a class="product-meta" href="">ios</a>
        ...
        <div class="container main-container">
            <div class="row mt-3 mb-5">
                <div class="col-sm-6 col-12 mb-2">
                    <div class="widget-banner">
                        <a href="#">
                            <img src="./assets/img/banner/medium-banner-1.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-sm-6 col-12 mb-2">
                    <div class="widget-banner">
                        <a href="#">
                            <img src="./assets/img/banner/medium-banner-2.jfif" alt="">
                        </a>
                    </div>
                </div>
            </div>
