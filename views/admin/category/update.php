        ...
        <section class="content">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form action="<?= url('admin/category/update') ?>?id=<?= $category['id'] ?>" method="post" class="col-12" id="barcodeForm">
                        <div class="form-group mx-1" style="display: inline-block;">
                            <label>نام دسته بندی</label>
                            <input name="name" value="<?= $category['name'] ?>" id="barcode" type="text" class="form-control" placeholder=""    >
                        </div>
                        <div>
