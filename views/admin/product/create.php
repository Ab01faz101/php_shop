        ...
        <section class="content">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form action="<?= url('admin/product/store') ?>" enctype="multipart/form-data" method="post" class="col-12 " style="width: 100%" id="barcodeForm">
                        ...
                        <div class="form-group mx-1" style="display: inline-block;">
                            ...
                            <input name="image" id="barcode" type="file" class="form-control" placeholder="" required>
                        </div>
                        <div class="form-group mx-1" style="display: inline-block;">
                            <label>قیمت محصول</label>
                            <input name="price" id="barcode" type="text" class="form-control" placeholder="" required>
                        </div>
                        <div class="form-group mx-1" style="display: inline-block;">
                        ...
                        <div class="form-group mx-1" style="display: inline-block;">
                            ...
                            <textarea name="description" id="barcode" type="text" class="form-control" placeholder="" required></textarea>
                        </div>
